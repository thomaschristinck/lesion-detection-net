...
class Config(object):
    ...
    CONTINUE_MODEL_PATH = os.path.join('/usr/local/data/thomasc/checkpoints/2d_detnet_training2/', "mask_rcnn_lesion_mask_rcnn_0045.pth")
    ...
    # implementation.
    LEARNING_RATE = 0.0025  #originally 0.0014
